...
const HELP: Record<string, HelpEntry> = {
  ...
  "/fetch-data": {
    title: "Fetch Data",
    html: `
      <p>Download GNSS position data for your station lists — a guided, three-step walkthrough.</p>
      <div class="help-section-label">Steps</div>
      <ul>
        <li><strong>Choose stations</strong> — pick one or more station lists</li>
      ...
      <ul>
        ...
        <li>Only one fetch runs at a time; you can switch to other tabs and the job keeps running</li>
  ...
  "/export": {
    ...
    html: `
      ...
      <ul>
        ...
        <li>Choose station list(s) and a date range, then click <strong>Convert</strong></li>
