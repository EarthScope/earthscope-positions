...
class UserApi:
    ...
    def get_aws_credentials(
        self,
        role: Annotated[AwsRole, Field(description="The IAM Role to retrieve credentials for. This controls which of EarthScope's AWS resources you can utilize.")],
        ...
        Get temporary AWS credentials that can interact directly with EarthScope's AWS resources (e.g. S3).  NOTE: direct access to datasets in S3 is restricted to the `us-east-2` region.  Available roles:  | **Role**      | **Description**                                                                | | ------------- | ------------------------------------------------------------------------------ | | `s3-dropoff`  | Grants direct access to EarthScope's dropoff S3 bucket                         | | `s3-miniseed` | Grants direct access to EarthScope's miniSEED archive in S3                    | | `s3-seafloor` | Grants direct access to EarthScope's experiemental seafloor geodesy data in S3 |

        :param role: The IAM Role to retrieve credentials for. This controls which of EarthScope's AWS resources you can utilize. (required)
        :type role: AwsRole
    ...
    def _get_aws_credentials_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/credentials/aws/{role}',
    ...
    @validate_call
    def get_fdsnws_basic_credentials(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """FDSNWS Credentials
         ...
         Retrieve FDSNWS (FDSN Web Services) basic HTTP credentials associated with your EarthScope account.  Basic HTTP authentication should be considered deprecated. New EarthScope APIs use oauth2. However, a number of standard and legacy FDSNWS access points continue to use basic HTTP authentication until new standards are adopted.  
        ...
        _param = self._get_fdsnws_basic_credentials_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_fdsnws_basic_credentials_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_fdsnws_basic_credentials_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_fdsnws_basic_credentials_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/credentials/basic/fdsnws',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_ntrip_basic_credentials(
        self,
        license_ids: Annotated[Optional[List[StrictStr]], Field(description=" The application keys to retrieve credentials for. If not provided, all credentials will be returned.  The application key is the NTRIP license ID. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """NTRIP Credentials
         ...
         Retrieve basic HTTP NTRIP credentials associated with your EarthScope account.  Basic HTTP authentication should be considered deprecated. New EarthScope APIs use oauth2. However, NTRIP continues to use basic HTTP authentication until new standards are adopted.  NTRIP credentials are tied to a specific NTRIP license. 

        :param license_ids:  The application keys to retrieve credentials for. If not provided, all credentials will be returned.  The application key is the NTRIP license ID. 
        ...
        _param = self._get_ntrip_basic_credentials_serialize(
    ...
    @validate_call
    def get_ntrip_basic_credentials_with_http_info(
        self,
        license_ids: Annotated[Optional[List[StrictStr]], Field(description=" The application keys to retrieve credentials for. If not provided, all credentials will be returned.  The application key is the NTRIP license ID. ")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[UserBasicCreds]]:
        """NTRIP Credentials
    ...
    @validate_call
    def get_ntrip_basic_credentials_without_preload_content(
        self,
        license_ids: Annotated[Optional[List[StrictStr]], Field(description=" The application keys to retrieve credentials for. If not provided, all credentials will be returned.  The application key is the NTRIP license ID. ")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_ntrip_basic_credentials_serialize(
        self,
        license_ids,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/credentials/basic/ntrip',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
