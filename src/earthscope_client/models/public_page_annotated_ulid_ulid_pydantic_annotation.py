...
class PublicPageAnnotatedULIDUlidPydanticAnnotation(BaseModel):
    """
    ...
    items: List[Annotated[str, Field(min_length=26, strict=True, max_length=26)]] = Field(description="Items in this page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicPageAnnotatedULIDUlidPydanticAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicPageAnnotatedULIDUlidPydanticAnnotation from a dict"""
        if obj is None:
            return None
