...
class STOFields(BaseModel):
    """
    STOFields
    """ # noqa: E501
    offset_label: StrictStr
    sbas_id: StrictStr
    tot: datetime
    utc_id: StrictStr
    __properties: ClassVar[List[str]] = ["offset_label", "sbas_id", "tot", "utc_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of STOFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of STOFields from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "offset_label": obj.get("offset_label"),
            "sbas_id": obj.get("sbas_id"),
            "tot": obj.get("tot"),
            "utc_id": obj.get("utc_id")
        })
        return _obj
