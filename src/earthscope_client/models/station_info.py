...
class StationInfo(BaseModel):
    ...
    pnum: Optional[StrictStr] = Field(default=None, description="Four character station name")
    igs: Optional[StrictStr] = Field(default=None, description="Nine character station name")
    ...
    __properties: ClassVar[List[str]] = ["edid", "pnum", "igs", "lat", "lon", "elev"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StationInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StationInfo from a dict"""
        if obj is None:
            return None
