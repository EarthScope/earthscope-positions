...
class StreamDataSplitResponse(BaseModel):
    """
    StreamDataSplitResponse
    """ # noqa: E501
    data: List[StrictStr] = Field(description="A list of relative urls with defined query parameters to query the PPP data.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StreamDataSplitResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StreamDataSplitResponse from a dict"""
        if obj is None:
            return None
