...
class NetworkNameMap(BaseModel):
    """
    Contains names for a Network represented as a mapping from `namespace -> name`.  Most of the time, only one of the names will be present as there is not a ton of overlap across network namespaces.
    """ # noqa: E501
    bsm: Optional[StrictStr] = Field(default=None, alias="BSM")
    fdsn: Optional[StrictStr] = Field(default=None, alias="FDSN")
    perm: Optional[StrictStr] = Field(default=None, alias="PERM")
    rtdb: Optional[StrictStr] = Field(default=None, alias="RTDB")
    shake: Optional[StrictStr] = Field(default=None, alias="SHAKE")
    __properties: ClassVar[List[str]] = ["BSM", "FDSN", "PERM", "RTDB", "SHAKE"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkNameMap from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkNameMap from a dict"""
        if obj is None:
            return None
