...
class AwsTemporaryCredentials(BaseModel):
    """
    Temporary AWS Credentials that can be used to interact with AWS services.
    """ # noqa: E501
    aws_access_key_id: StrictStr
    aws_secret_access_key: StrictStr
    aws_session_token: StrictStr
    expiration: datetime
    __properties: ClassVar[List[str]] = ["aws_access_key_id", "aws_secret_access_key", "aws_session_token", "expiration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwsTemporaryCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwsTemporaryCredentials from a dict"""
        if obj is None:
            return None
