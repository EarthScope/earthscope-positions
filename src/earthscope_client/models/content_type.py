...
class ContentType(str, Enum):
    ...
    APPLICATION_SLASH_JSON_PLUS_SERIES = 'application/json+series'
    APPLICATION_SLASH_JSON_PLUS_COMPACT_MINUS_GEOJSON = 'application/json+compact-geojson'
    TEXT_SLASH_CSV = 'text/csv'
    APPLICATION_SLASH_VND_DOT_APACHE_DOT_PARQUET = 'application/vnd.apache.parquet'
    APPLICATION_SLASH_VND_DOT_APACHE_DOT_ARROW_DOT_FILE = 'application/vnd.apache.arrow.file'
    STAR_SLASH_STAR = '*/*'
