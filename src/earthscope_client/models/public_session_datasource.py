...
class PublicSessionDatasource(BaseModel):
    """
    A session datasource.  Acts as a unique identifier for a particular recording configuration on a station's receiver.
    """ # noqa: E501
    ...
    sample_interval: SessionSampleInterval
    roll: SessionRollPeriod = Field(description="Session file roll period (in seconds)")
    names: SessionNameMap
    __properties: ClassVar[List[str]] = ["description", "edid", "station", "station_edid", "sample_interval", "roll", "names"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSessionDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSessionDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "roll": obj.get("roll"),
            "names": SessionNameMap.from_dict(obj["names"]) if obj.get("names") is not None else None
        })
        return _obj
