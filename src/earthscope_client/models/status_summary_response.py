...
class StatusSummaryResponse(BaseModel):
    """
    Class representing a response of status count items in the API.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatusSummaryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatusSummaryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [StatusCountItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
