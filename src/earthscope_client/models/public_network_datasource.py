...
class PublicNetworkDatasource(BaseModel):
    """
    A network datasource.  Acts as a parent for a group of stations. All stations within a network have unique names.
    """ # noqa: E501
    description: Optional[StrictStr] = None
    edid: Annotated[str, Field(min_length=26, strict=True, max_length=26)] = Field(description="EarthScope Datasource ID (EDID)")
    names: NetworkNameMap
    __properties: ClassVar[List[str]] = ["description", "edid", "names"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicNetworkDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicNetworkDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "edid": obj.get("edid"),
            "names": NetworkNameMap.from_dict(obj["names"]) if obj.get("names") is not None else None
        })
        return _obj
