...
class UserBasicCreds(BaseModel):
    """
    UserBasicCreds
    """ # noqa: E501
    username: StrictStr
    password: StrictStr
    user_id: StrictStr
    context: Optional[Dict[str, ContextValue]] = Field(default=None, description="Additional context for the basic credentials")
    expires_at: Optional[datetime] = Field(default=None, description="Expiration date of the basic credentials in UTC")
    id: StrictStr
    application: BasicCredApplication
    application_key: StrictStr
    __properties: ClassVar[List[str]] = ["username", "password", "user_id", "context", "expires_at", "id", "application", "application_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserBasicCreds from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserBasicCreds from a dict"""
        if obj is None:
            return None
