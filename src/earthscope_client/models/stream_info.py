...
class StreamInfo(BaseModel):
    ...
    StreamInfo
    """ # noqa: E501
    edid: StrictStr = Field(description="EarthScope Datasource ID")
    geosncl: Optional[StrictStr] = Field(default=None, description="ShakeAlert stream name")
    sn: Optional[StrictStr] = Field(default=None, description="EarthScope stream name")
    lat: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Station latitude")
    lon: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Station longitude")
    elev: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Station elevation")
    station: Optional[StationInfo] = None
    stream_type: StreamType
    facility: Facility
    software: StreamSoftware
    label: StrictStr = Field(description="Free-form text label for this stream")
    sample_interval: StrictInt = Field(description="The sample interval of this stream, in milliseconds")
    __properties: ClassVar[List[str]] = ["edid", "geosncl", "sn", "lat", "lon", "elev", "station", "stream_type", "facility", "software", "label", "sample_interval"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StreamInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StreamInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "edid": obj.get("edid"),
            "geosncl": obj.get("geosncl"),
            "sn": obj.get("sn"),
            "lat": obj.get("lat"),
            "lon": obj.get("lon"),
            "elev": obj.get("elev"),
            "station": StationInfo.from_dict(obj["station"]) if obj.get("station") is not None else None,
