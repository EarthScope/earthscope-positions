...
class PageDropoffItems(BaseModel):
    """
    Class representing a paginated response of dropoff items in the API.
    """ # noqa: E501
    has_next: StrictBool
    offset: StrictInt
    limit: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageDropoffItems from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageDropoffItems from a dict"""
        if obj is None:
            return None
