...
class InstPositionSeries(BaseModel):
    """
    InstPositionSeries
    """ # noqa: E501
    time: List[StrictInt] = Field(description="The time of the observation, in millisconds since 1970.")
    east: List[Union[StrictFloat, StrictInt]] = Field(description="The east displacement from the reference position, in meters.")
    north: List[Union[StrictFloat, StrictInt]] = Field(description="The north displacement from the reference position, in meters.")
    up: List[Union[StrictFloat, StrictInt]] = Field(description="The up displacement from the reference position, in meters.")
    sig_ee: List[Union[StrictFloat, StrictInt]] = Field(description="The standard deviation for the east component, in meters.", alias="sigEE")
    sig_nn: List[Union[StrictFloat, StrictInt]] = Field(description="The standard deviation for the north component, in meters.", alias="sigNN")
    sig_uu: List[Union[StrictFloat, StrictInt]] = Field(description="The standard deviation for the up component, in meters.", alias="sigUU")
    q_channel: List[StrictInt] = Field(description=" The integer encoded ShakeAlert quality metric defined as: - `nsat` = number of satellites used in the solution - `PDOP` = position dilution of precision, measures the quality of the satellite geometry - `fixtyp` = the type of the position solution, such as global network PPP, bias fixed or free (`Chi2` - in the case of Fastlane)          `qChannel = 10000 * int(10*PDOP) + 100*nsat + fixtyp` ", alias="qChannel")
    __properties: ClassVar[List[str]] = ["time", "east", "north", "up", "sigEE", "sigNN", "sigUU", "qChannel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstPositionSeries from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstPositionSeries from a dict"""
        if obj is None:
            return None
