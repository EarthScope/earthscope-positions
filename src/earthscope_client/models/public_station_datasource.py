...
class PublicStationDatasource(BaseModel):
    """
    A station datasource.
    """ # noqa: E501
    description: Optional[StrictStr] = None
    edid: Annotated[str, Field(min_length=26, strict=True, max_length=26)] = Field(description="EarthScope Datasource ID (EDID)")
    networks: Optional[List[PublicNetworkDatasource]] = None
    network_edids: Optional[List[Annotated[str, Field(min_length=26, strict=True, max_length=26)]]] = None
    names: StationNameMap
    __properties: ClassVar[List[str]] = ["description", "edid", "networks", "network_edids", "names"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicStationDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicStationDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "edid": obj.get("edid"),
            "networks": [PublicNetworkDatasource.from_dict(_item) for _item in obj["networks"]] if obj.get("networks") is not None else None,
            "network_edids": obj.get("network_edids"),
            "names": StationNameMap.from_dict(obj["names"]) if obj.get("names") is not None else None
        })
        return _obj
