...
class PublicPagePublicStreamDatasource(BaseModel):
    """
    ...
    items: List[PublicStreamDatasource] = Field(description="Items in this page")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicPagePublicStreamDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicPagePublicStreamDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "items": [PublicStreamDatasource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
