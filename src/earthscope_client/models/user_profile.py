...
class UserProfile(BaseModel):
    ...
    UserProfile
    """ # noqa: E501
    first_name: Optional[StrictStr] = Field(default=None, description="First name of user")
    last_name: Optional[StrictStr] = Field(default=None, description="Last name of user")
    country_code: Optional[StrictStr] = Field(default=None, description="Country code of user")
    region_code: Optional[StrictStr] = Field(default=None, description="Region code of user")
    institution: Optional[StrictStr] = Field(default=None, description="Institution the user is associated with")
    work_sector: Optional[WorkSector] = None
    user_id: Optional[StrictStr] = Field(default=None, description="EarthScope User ID (EUID)")
    primary_email: Optional[StrictStr] = None
    created_at: Optional[datetime] = Field(default=None, description="Time of profile creation")
    updated_at: Optional[datetime] = Field(default=None, description="Time of last profile udpate")
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "country_code", "region_code", "institution", "work_sector", "user_id", "primary_email", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "work_sector": obj.get("work_sector"),
