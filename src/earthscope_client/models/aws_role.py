...
class AwsRole(str, Enum):
    ...
    allowed enum values
    """
    S3_MINUS_DROPOFF = 's3-dropoff'
    S3_MINUS_MINISEED = 's3-miniseed'
    S3_MINUS_SEAFLOOR = 's3-seafloor'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AwsRole from a JSON string"""
