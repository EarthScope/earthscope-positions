...
class StatusCountItem(BaseModel):
    """
    Class representing a status count item in the API response.  Attributes:     status (str): The status of the dropoff items.     count (int): The count of dropoff items with the given status.
    """ # noqa: E501
    status: StrictStr
    count: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatusCountItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatusCountItem from a dict"""
        if obj is None:
            return None
