...
class CompactGeoJSON(BaseModel):
    """
    CompactGeoJSON
    """ # noqa: E501
    ...
    coor: List[Union[StrictFloat, StrictInt]] = Field(description="The displacement from the reference position, in meters - `[east,north,up]`.")
    err: List[Union[StrictFloat, StrictInt]] = Field(description="The standard deviation for the east, north, up components, in meters - `[east,north,up]`.")
    __properties: ClassVar[List[str]] = ["time", "qChannel", "coor", "err"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompactGeoJSON from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompactGeoJSON from a dict"""
        if obj is None:
            return None
