...
class PublicPagePublicNetworkDatasource(BaseModel):
    """
    PublicPagePublicNetworkDatasource
    """ # noqa: E501
    has_next: StrictBool = Field(description="True if another page follows this one")
    offset: Annotated[int, Field(strict=True, ge=0)] = Field(description="Pagination start offset")
    limit: Annotated[int, Field(le=1000, strict=True, ge=1)] = Field(description="Pagination size limit")
    items: List[PublicNetworkDatasource] = Field(description="Items in this page")
    __properties: ClassVar[List[str]] = ["has_next", "offset", "limit", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicPagePublicNetworkDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicPagePublicNetworkDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "items": [PublicNetworkDatasource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
