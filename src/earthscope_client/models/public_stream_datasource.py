...
class PublicStreamDatasource(BaseModel):
    """
    A stream datasource.  Acts as a unique identifier for a particular timeseries coming from a station.
    """ # noqa: E501
    description: Optional[StrictStr] = None
    edid: Annotated[str, Field(min_length=26, strict=True, max_length=26)] = Field(description="EarthScope Datasource ID (EDID)")
    station: Optional[PublicStationDatasource] = None
    station_edid: Optional[Annotated[str, Field(min_length=26, strict=True, max_length=26)]] = None
    stream_type: StreamType = Field(description="What type of stream is this?")
    facility: Optional[Facility] = Field(default=None, description="From which facility did this stream originate?")
    software: StreamSoftware = Field(description="What software created this stream?")
    label: StrictStr = Field(description="Free-form string label for the stream")
    sample_interval: StreamSampleInterval = Field(description="Stream sample interval (in milliseconds)")
    names: StreamNameMap
    __properties: ClassVar[List[str]] = ["description", "edid", "station", "station_edid", "stream_type", "facility", "software", "label", "sample_interval", "names"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicStreamDatasource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicStreamDatasource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "edid": obj.get("edid"),
            "station": PublicStationDatasource.from_dict(obj["station"]) if obj.get("station") is not None else None,
            "station_edid": obj.get("station_edid"),
            "stream_type": obj.get("stream_type"),
            "facility": obj.get("facility"),
            "software": obj.get("software"),
            "label": obj.get("label"),
            "sample_interval": obj.get("sample_interval"),
            "names": StreamNameMap.from_dict(obj["names"]) if obj.get("names") is not None else None
        })
        return _obj
