...
from earthscope_client.api_response import ApiResponse, T as ApiResponseT
import earthscope_client.models
from earthscope_client import rest
from earthscope_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(earthscope_client.models, klass)
